...
driver.get("https://www.faz.net/")

time.sleep(5)
driver.switch_to.frame(driver.find_element(By.XPATH, '//iframe[@title="SP Consent Message"]'))
driver.find_element(By.XPATH, '//button[@title="EINVERSTANDEN"]').click()
...
data = ["FAZ", numberOfArticles, numberOfCoronaArticles, numberOfCoronaArticles/numberOfArticles, date.today(), content['weekIncidence'], content['r']['value'], content['casesPer100k'], content['casesPerWeek']]
